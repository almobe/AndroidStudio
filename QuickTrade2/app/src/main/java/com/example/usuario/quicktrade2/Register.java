package com.example.usuario.quicktrade2;
       ...
       // import com.example.usuario.quicktrade.model.usuarios;
        import com.example.usuario.quicktrade2.model.usuarios;
...
/**
 * Created by USUARIO on 26/12/2017.
 */

public class Register extends AppCompatActivity{
    //private FirebaseAuth mAuth;
    private EditText edit_passwordR;
    private EditText edit_mailR;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_mailR = (EditText) findViewById(R.id.editMailRegister);
        edit_passwordR = (EditText) findViewById(R.id.editPasswordRegister);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String correo = edit_mailR.getText().toString();
                final String direccion = edit_direccion.getText().toString();
                final String password = edit_passwordR.getText().toString();
